...
In addition to, we find that the *extent* to which these districts are right or left leaning is not balanced. Districts that are more ive (or right-leaning), on average, are much greater than liberal (or left-leaning) Districts. In other words, 
**ive Districts tend to be much more radically so than liberal Districts.**
